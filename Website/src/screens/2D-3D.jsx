    ...
    <main className="overflow-hidden">
      <section className="h-[90vh] w-full relative ">
        ...
        <img
          src={Drone}
          alt=""
          className=" absolute -right-10 -bottom-36 z-40 hidden md:block"
        />
      </section>
      <section className=" py-4 w-full mx-auto max-w-6xl md:mt-24">
        <div className="w-full px-16 py-10 text-justify">
          <p className="font-bold text-2xl md:text-4xl mb-3 text-justify">
      ...
      <section className="w-full mx-auto font-medium max-w-6xl">
        <div className="w-full px-16">
          <div className="flex justify-between items-center flex-wrap">
            <p className="font-bold text-2xl md:text-4xl mb-3">
              2D View: Precision in Planning
            </p>
            <div
              className="bg-white flex justify-center items-center cursor-pointer select-none border-2 rounded-full ml-auto md:ml-0 mb-4 md:mb-0"
              onClick={() =>
          ...
          <div className="w-full flex justify-center text-justify items-center md:items-start flex-col md:flex-row mx-auto gap-5">
            <img
              src={data[view].image}
              alt=""
              className="w-[90%] md:w-[45%] object-cover"
            />
            <p className="text-justify mt-10">{data[view].description}</p>
          </div>
        </div>
      </section>
      ...
      <img
        src={ImageOne}
        alt=""
        className="w-[76%] mx-auto mb-10 rounded object-cover"
      />
    </main>
  );
}
